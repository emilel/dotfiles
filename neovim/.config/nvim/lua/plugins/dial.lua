    ...
    config = function()
        ...
        require("dial.config").augends:register_group {
            default = {
                ...
                augend.constant.new({ elements = { "x86_64-linux-gnu", "xtensa-intel-lunarlake" }, }),
                augend.constant.new({ elements = { "Lodur_Griffin2_IntelDSP", "CEngineTests", "TorchSourceTopos" }, }),
